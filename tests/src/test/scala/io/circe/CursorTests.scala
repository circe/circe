...
class CursorTests extends CursorSuite[Cursor, Functor] {
...
class HCursorTests extends CursorSuite[HCursor, Functor] {
...
class ACursorTests extends CursorSuite[ACursor, Applicative] {
