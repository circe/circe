...
import io.circe.generic.simple.codec.{ DerivedAsObjectCodec, ReprAsObjectCodec }
import io.circe.generic.simple.decoding.{ DerivedDecoder, ReprDecoder }
import io.circe.generic.simple.encoding.{ DerivedAsObjectEncoder, ReprAsObjectEncoder }
import io.circe.generic.simple.util.macros.DerivationMacros
...
class Deriver(val c: whitebox.Context)
  ...
  protected[this] val hnilReprDecoder: Tree = q"_root_.io.circe.generic.simple.decoding.ReprDecoder.hnilReprDecoder"
  protected[this] val hnilReprCodec: Tree = q"_root_.io.circe.generic.simple.codec.ReprAsObjectCodec.hnilReprCodec"
