...
object Derivation {
  ...
  inline final def summonDecoders[T <: Tuple]: Array[Decoder[_]] = summonDecoders[T].toArray
  inline final def summonEncoders[T <: Tuple]: Array[Encoder[_]] = summonEncoders[T].toArray
