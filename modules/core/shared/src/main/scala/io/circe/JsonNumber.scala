...
private sealed abstract class BiggerDecimalJsonNumber(input: String) extends JsonNumber {
  ...
  private[circe] final def appendToStringBuilder(builder: StringBuilder): Unit = void(builder.append(input))
}
...
private[circe] final case class JsonBigDecimal(value: JavaBigDecimal) extends JsonNumber {
  ...
  private[circe] def appendToStringBuilder(builder: StringBuilder): Unit = void(builder.append(value.toString))
}
...
private[circe] final case class JsonLong(value: Long) extends JsonNumber {
  ...
  private[circe] def appendToStringBuilder(builder: StringBuilder): Unit = void(builder.append(value))
}
