  ...
  */
  private[circe] class Printer(
    ...
    /**
      ...
      */
    override final def pretty(json: Json): String = {
    ...
    override final def prettyByteBuffer(json: Json, cs: Charset): ByteBuffer = {
    ...
    override final def prettyByteBuffer(json: Json): ByteBuffer =
